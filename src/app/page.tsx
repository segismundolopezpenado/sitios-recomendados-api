...
>>>>>>> b262a314992c237e2474745dd9ebd1c634309a44
const provinces = [
  "A Coruña",
  "Lugo",
  "Ourense",
...
<<<<<<< HEAD
          ...
          // Si es una URL normal, abrirla en una nueva pestaña
          window.open(route.gpxLink, '_blank');
        }
      } catch (error) {
        console.error('Error downloading GPX:', error);
        toast.error('Error al descargar el archivo GPX');
      }
    }
  };
...
<<<<<<< HEAD
  // Form components
  const AddSiteForm = ({ initialData, onSubmit, onCancel, isSubmitting }: {
    initialData?: Site | null;
    onSubmit: (data: Omit<Site, 'id' | 'createdAt' | 'updatedAt'>) => void;
    onCancel: () => void;
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Select value={formData.type} onValueChange={(value: "comer" | "dormir") => setFormData({ ...formData, type: value })}>
              ...
              <SelectContent>
                <SelectItem value="comer">Para comer</SelectItem>
                <SelectItem value="dormir">Para dormir</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div>
            <Label htmlFor="mapsLink">Enlace a Maps (opcional)</Label>
            <Input
              id="mapsLink"
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Añade comentarios sobre el lugar..."
            className="bg-gray-800 border-gray-600 text-white"
          />
        </div>
        ...
        <div className="flex justify-end space-x-2 pt-4">
          <Button type="button" variant="outline" onClick={onCancel} className="border-gray-600 text-white hover:bg-gray-800">
            Cancelar
          </Button>
          <Button type="submit" disabled={isSubmitting} className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600">
  ...
  const AddRouteForm = ({ initialData, onSubmit, onCancel, isSubmitting }: {
    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <Label htmlFor="routeProvince">Provincia</Label>
            <Select value={formData.province} onValueChange={(value) => setFormData({ ...formData, province: value })}>
              <SelectTrigger className="bg-gray-800 border-gray-600 text-white">
                <SelectValue placeholder="Selecciona una provincia" />
              </SelectTrigger>
          ...
          <div>
            <Label htmlFor="routeMapsLink">Enlace a Maps (opcional)</Label>
            <Input
              id="routeMapsLink"
              value={formData.mapsLink}
              onChange={(e) => setFormData({ ...formData, mapsLink: e.target.value })}
          ...
          <div>
            <Label htmlFor="wikilocLink">Enlace a Wikiloc (opcional)</Label>
            <Input
              id="wikilocLink"
        ...
        <div>
          <Label htmlFor="gpxLink">Enlace a GPX o archivo GPX (opcional)</Label>
          <Input
            id="gpxLink"
            value={formData.gpxLink}
            onChange={(e) => setFormData({ ...formData, gpxLink: e.target.value })}
            placeholder="URL del GPX o deja vacío para subir archivo"
            className="bg-gray-800 border-gray-600 text-white"
          />
        </div>
        ...
        <div>
          ...
          <Textarea
            ...
            value={formData.comments}
            onChange={(e) => setFormData({ ...formData, comments: e.target.value })}
            placeholder="Añade comentarios sobre la ruta..."
            className="bg-gray-800 border-gray-600 text-white"
          />
        </div>
        ...
        <div className="flex justify-end space-x-2 pt-4">
          ...
          <Button type="submit" disabled={isSubmitting} className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600">
            {isSubmitting ? "Guardando..." : initialData ? "Actualizar" : "Añadir"}
          </Button>
        </div>
      </form>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-violet-900/20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 via-pink-500 to-violet-500 bg-clip-text text-transparent mb-4">
            Sitios Recomendados
          </h1>
...
<<<<<<< HEAD
                className="bg-gray-800/60 border-gray-600 text-white placeholder:text-gray-400 pl-10"
              />
            </div>
            <Select value={filterType} onValueChange={(value: "todos" | "comer" | "dormir" | "rutas") => setFilterType(value)}>
              <SelectTrigger className="w-48 bg-gray-800/60 border-gray-600 text-white">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="flex justify-center gap-4 mb-8">
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="bg-gray-900 border-white/20 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <AddSiteForm onSubmit={handleAddSite} onCancel={() => setIsAddDialogOpen(false)} isSubmitting={isSubmitting} />
            </DialogContent>
          </Dialog>
        ...
        <div className="min-w-[200px]">
          <div className="flex justify-between items-center mb-3">
            <div className="flex gap-2">
              ...
              <button
                ...
                title={viewMode === "cards" ? "Ver como lista" : "Ver como fichas"}
              >
                {viewMode === "cards" ? (
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              <span className="text-orange-400 font-medium">Comer:</span>
              <span className="text-white font-bold">{filteredComerCount}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-blue-400 font-medium">Dormir:</span>
              <span className="text-white font-bold">{filteredDormirCount}</span>
=======
        ...
        <div className="space-y-6">
          ...
          {viewMode === "cards" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {filteredRoutes.map((route) => (
                <Card key={route.id} className="bg-gradient-to-br from-gray-800/80 via-green-800/60 to-teal-800/80 backdrop-blur-sm border-green-500/30 text-white hover:border-green-400/50 transition-all duration-300 shadow-xl">
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      <div>
                        <CardTitle className="text-xl font-bold bg-gradient-to-r from-green-400 via-blue-500 to-teal-500 bg-clip-text text-transparent">
                          {route.name}
                        </CardTitle>
                        <CardDescription className="text-gray-300">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      {route.difficulty && (
                        <div>
                          ...
                          <Badge variant="outline" className={
                            route.difficulty === "Fácil" ? "border-blue-500 text-blue-300 bg-blue-500/10" :
                            route.difficulty === "Moderado" ? "border-yellow-500 text-yellow-300 bg-yellow-500/10" :
                            route.difficulty === "Difícil" ? "border-orange-500 text-orange-300 bg-orange-500/10" :
                      ...
                      {route.comments && (
                        <div>
                          <p className="text-sm text-gray-400 mb-1">Comentarios</p>
                          <p className="text-gray-300 text-sm">{route.comments}</p>
                        </div>
                      )}

                      {route.photos && route.photos.length > 0 && (
                        <div>
                          <p className="text-sm text-gray-400 mb-2">Fotos ({route.photos.length})</p>
                          <div className="grid grid-cols-3 gap-2">
                            {route.photos.slice(0, 3).map((photo, index) => (
                              <div key={index} className="relative group aspect-square bg-gray-700/50 rounded-lg overflow-hidden border border-white/10 cursor-pointer" onClick={() => handleImageClick(photo)}>
                                <img 
                                  src={photo} 
                                  alt={`Foto ${index + 1}`} 
                                  className="w-full h-full object-cover transition-transform group-hover:scale-105"
                                  onError={(e) => {
                                    console.log(`Error cargando imagen de ruta ${index + 1}:`, photo.substring(0, 100));
                                    const target = e.target as HTMLImageElement;
                                    target.style.display = 'none';
                                    const parent = target.parentElement;
                                    if (parent) {
                      ...
                      <div className="flex gap-2 pt-4">
                        <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white flex-1" onClick={() => handleViewRouteOnMaps(route)}>
                          <MapPin className="mr-2 h-4 w-4" />
                          Maps
                        </Button>
                        <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white flex-1" onClick={() => handleViewOnWikiloc(route)}>
                        ...
                        {route.gpxLink && (
                          <Button size="sm" className="bg-purple-600 hover:bg-purple-700 text-white" onClick={() => handleDownloadGPX(route)}>
                            <Download className="h-4 w-4" />
                          </Button>
                        )}
                        <Dialog>
                          <DialogTrigger asChild>
                            <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white" onClick={() => setEditingRoute(route)}>
                              <Edit className="h-4 w-4" />
                            </Button>
                          </DialogTrigger>
                          <DialogContent className="bg-gray-900 border-white/20 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          {viewMode === "list" && (
            <div className="space-y-2">
              {/* Sites List */}
              {filteredSites.map((site) => (
                <div key={site.id} className="flex items-center justify-between p-4 bg-gray-800/60 border border-gray-700 rounded-lg hover:bg-gray-800/80 transition-colors">
                  <div className="flex items-center space-x-4">
                    <Badge variant={site.type === "comer" ? "default" : "secondary"} 
                           className={site.type === "comer" 
                             ? "bg-orange-500 hover:bg-orange-600 text-white" 
                             : "bg-blue-500 hover:bg-blue-600 text-white"}>
                      {site.type === "comer" ? "Comer" : "Dormir"}
                    </Badge>
                    <span className="text-white font-medium">{site.name}</span>
                    <span className="text-gray-400 text-sm">{site.province}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white" onClick={() => handleViewOnMaps(site)}>
...
<<<<<<< HEAD
              ...
              {/* Routes List */}
              {filteredRoutes.map((route) => (
                <div key={route.id} className="flex items-center justify-between p-4 bg-gray-800/60 border border-gray-700 rounded-lg hover:bg-gray-800/80 transition-colors">
                  <div className="flex items-center space-x-4">
                    <Badge variant="default" className="bg-green-500 hover:bg-green-600 text-white">
                      Ruta
                    </Badge>
                    <span className="text-white font-medium">{route.name}</span>
                    <span className="text-gray-400 text-sm">{route.province || ""}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white" onClick={() => handleViewRouteOnMaps(route)}>
                      <MapPin className="h-4 w-4" />
                    </Button>
                    <Dialog>
                      <DialogTrigger asChild>
